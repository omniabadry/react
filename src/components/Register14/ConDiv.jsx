...
export const ConDiv = () => {
 ...
 <div className="col-3 d-xl-block d-lg-none d-sm-none d-md-none d-none ">
  ...
  <button className="btn active buttons"><i className="fas fa-user-tie" /> &nbsp; &nbsp; {t("Title")} &amp; {("Overview")}
  </button><br />
  <button className="btn active buttonSelected13"><i className="fas fa-camera" /> &nbsp; &nbsp; {t("Profile Photo")}
  </button><br />
