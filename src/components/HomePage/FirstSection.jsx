...
export const FirstSection = () => {
    return (
       <section className="pt-4 pt-md-11" style={{backgroundImage: 'url(https://www.upwork.com/static/assets/Brontes/7814396/img/xl.24b3e20.jpg)', backgroundPosition: '50%', backgroundSize: 'cover !important', backgroundRepeat: 'no-repeat', padding: '20px 0'}}>
      ...
      <div className="col-12 col-md-7 col-lg-10 order-md-1 aos-init aos-animate" data-aos="fade-up">
        ...
        <div className="row">
          <h1 className="text-success vs-text-canela vs-color-up-green mb-4 col-10 col-sm-8 col-xl-7">
            In-demand talent <span className="nowrap onDemandPara">on demand.<sup>TM</sup></span><br /> <span className="second-header onDemandPara">Upwork is how.<sup>TM</sup></span></h1>
        </div>
        {/* Text */}
        <div className="row">
        ...
        <div>
          <div className="text-light d-flex d-md-block mb-3 mb-md-0">
            <button tabIndex={0} className="btn btn-light cta-group__btn up-btn up-btn-default mb-0 ml-5 mr-2">
              Watch Demo
            </button>
