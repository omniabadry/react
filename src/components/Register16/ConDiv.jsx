...
export const ConDiv = () => {
 ...
 <div className="col-3 d-xl-block d-lg-none d-sm-none d-md-none d-none ">
  ...
  <button className="btn active buttons"><i className="fas fa-dollar-sign" /> &nbsp; &nbsp; {t("Hourly Rate")}</button><br />
  <button className="btn active buttons"><i className="fas fa-user-tie" /> &nbsp; &nbsp; {t("Title")} &amp; {t("Overview")}
  </button><br />
  <button className="btn active buttons"><i className="fas fa-camera" /> &nbsp; &nbsp; {t("Profile Photo")}
  </button><br />
  <button className="btn active buttons"><i className="fas fa-map-marker-alt" /> &nbsp; &nbsp;{t("Location")}</button><br />
  <button className="btn active buttonSelected16"><i className="fas fa-phone-alt" /> &nbsp; &nbsp; {t("Phone")} </button><br />
</div>
