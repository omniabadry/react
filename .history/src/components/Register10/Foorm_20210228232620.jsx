      ...
      <div className="col-xl-7 col-12 col-sm-12 col-md-12" id="form9Design">
        <div>
          <p className="card crdhd">
            <b>{t("Employment")}</b>
            <span className="text-muted mutepara">{t("5 of 11")}</span>
          </p>
          <div id="crd">
            <h2 className="text-left">{t("Add your past work experience")}</h2>
            <p className="card-title" id="crdtitle">
              {t("Build your credibility by showcasing the projects or jobs you have completed.")}
            </p>
            <br />{" "}
            <div className="row">
              <div className="col-12 mb-5">
                <button
                  className="btn btn-outline addEdue9"
                  onClick={openModal}
                >
                  <i className="fas fa-plus" />
                  &nbsp;&nbsp;<b>{t("Add employment")}</b>
                </button>
                <br />
                <br />
                <br />
                  ...
                  <div className=" mt-0 pt-1">
                    <form onSubmit={handleSubmit(onSubmit)}>
                      <div className="col-lg-12">
                        <div className="form-group">
                          <div className="sn-field ">
                            <label className="text-left mt-3 mb-3">
                              <b>{t("Company")}</b>
                            </label>
                            <br />

                            {/* <input className="text-left mb-2 col-lg-12 radius" type="text" name="school" ref={register} placeholder={t("EX: Northwestern University")} /> */}
                            <input
                              className=" text-left mb-2 p-4 col-lg-12 "
                              type="text"
                        ...
                        <div className="price-sec">
                          ...
                          <div className="form-group">
                            ...
                            <div className="row">
                              ...
                              <div className="sn-field col-lg-4">
                                <Datetime
                                  onChange={(date) =>
                                    changeDate(date, "to_date")
                                  }
                                  dateFormat="MMMM YYYY"
                                  timeFormat={false}
                                  closeOnSelect
                                  ...
                                  initialValue={
                                    watch("to_date") &&
                                    moment(watch("to_date")).format("MMMM YYYY")
                                  }
                                  isValidDate={(current) =>
                                    watch("from_date")
                      ...
                      <div className="modal-footer">
                        ...
                        <button
                          type="submit"
                          className="btn btn-outline-success saveAddMore d-lg-inline d-none"
                        >
                          {" "}
                          {t("Save")} &amp; {t("Add More")}{" "}
                        </button>
