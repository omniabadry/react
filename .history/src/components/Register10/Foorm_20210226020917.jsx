                                        ...
                                        <div className="col-lg-12">
                                            <div className="form-group">
                                                <div className="sn-field ">
                                                    ...
                                                    <input className=" text-left mb-2 p-4 col-lg-12 " type="text" style={{ borderRadius: '0.5rem' }} name="Company" ref={register} /><br />
                                        ...
                                        <div className="col-lg-4">
                                            <div className="form-group">
                                                <div className="sn-field">
                                                    ...
                                                    <input className="text-left mb-2 col-lg-12 radius" type="text" ref={register} name="City" placeholder={t("Ex: Bachelor's")} />
                                                </div>
