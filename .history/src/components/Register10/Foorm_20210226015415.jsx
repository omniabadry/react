                                        ...
                                        <div className="col-lg-12">
                                            <div className="form-group">
                                                <div className="sn-field ">
                                                    ...
                                                    <input className=" text-left mb-2 p-4 col-lg-12 " type="text" style={{ borderRadius: '0.5rem' }} name="Company" ref={register} placeholder={t("EX: Northwestern University")} /><br />
