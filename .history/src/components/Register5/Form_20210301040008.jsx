      ...
      <div className="card-fluid">
        ...
        <div className="card-body" id="crd">
          <h3 className="card-title" id="crdtitle">
            {t("How would you like to fill out your profile?")}
          </h3>
          <br />
          ...
          <br />
          <button className="btn btn-link btn-outline" id="uploadBtn" href="#">
            <b>
              {t("Upload Your LinkedIn Profile")}
            </b>
          </button>
          <br />
          <br />
          <button
            ...
            id="startBtn"
            type="submit"
            onClick={handleRegisterNext5}
          >
            <b>{t("Fill Out Manually")}</b>
          </button>
        </div>
      </div>
    </form>
