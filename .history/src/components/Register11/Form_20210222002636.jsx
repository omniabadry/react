    ...
    <form className="col-xl-8 col-12 col-sm-12 col-md-12" id="form11Design">
      <div className="card-fluid">
        ...
        <div className="card-footer bg-white crdfooter">
           <button className="btn btn-link btn-success col-lg-5 col-sm-12 mb-3" id="nextBtn6"><b>Next</b></button>
          <button className="btn btn-link btn-outline col-lg-5 col-sm-12" id="backBtn"><b>Back</b></button>
        </div>
      </div>
    </form>
