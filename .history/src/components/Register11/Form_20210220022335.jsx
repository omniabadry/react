...
export const Form = () => {
  return (
    <div className="col-xl-7 col-12 col-sm-12 col-md-12" id="form11Design">
  <div className="card-fluid">
    ...
    <div className="card-footer bg-white crdfooter">
      <a href="../11/signUp11.html"> <button className="btn btn-link btn-success" id="nextBtn6" href="#"><b>Next</b></button></a>
