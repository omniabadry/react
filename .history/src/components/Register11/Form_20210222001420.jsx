    ...
    <form className="col-xl-8 col-12 col-sm-12 col-md-12" id="form11Design">
      <div className="card-fluid">
        ...
        <div className="card-footer bg-white crdfooter">
          <a href="../11/signUp11.html"> <button className="btn btn-link btn-success col-lg-5 col-sm-12 mb-3" id="nextBtn6" href="#"><b>Next</b></button></a>
          <a href="../9/signUp9.html"> <button className="btn btn-link btn-outline col-lg-5 col-sm-12" id="backBtn" href="#"><b>Back</b></button></a>
        </div>
      </div>
    </form>
