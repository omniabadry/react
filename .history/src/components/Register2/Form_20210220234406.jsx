...
export const Form = (props) => {
  ...
  <div className="col-xl-6 col-12 col-sm-12 col-md-12" id="form2Design">
    ...
    <div className="row" id="inputbox">
            <div className="col-5" id="firstName" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="col-5" id="lastName" >
        {/* <i class="fas fa-user" id="icon2"></i> */}
              <input type="text" className={`form-control outline first ${Register2Errors.LastNameErrors ? "border-danger" : ""}`} placeholder="Last name" name='LastName'  />
      </div>
