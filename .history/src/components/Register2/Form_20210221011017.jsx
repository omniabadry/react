        ...
        <div className="row">
            ...
            <div className="check">
                <input type="checkbox"  name='check' ref={register}
                  className={`form-control p-2 ${errors.check ? "border-danger" : ""}`} /> Yes! Send me genuinely useful emails every
          now and then to help me get the most out of Upwork.
            ...
            <div className="check2">
                <input type="checkbox" name='check' ref={register} 
                className={`form-control p-2 ${errors.check ? "border-danger" : ""}`}/> Yes, I understand and agree to the
