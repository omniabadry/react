  ...
  return (
    <div className="row">
      ...
      <div className="col-xl-6 col-12 col-sm-12 col-md-12" id="form2Design">
        ...
        <div className="row" id="inputbox" onSubmit={handleSubmit(onSubmit)}>
          <div className="col-5" id="firstName" >
            {/* <i class="fas fa-user" id="icon"></i> */}
            <input type="text" className={`form-control outline first ${Register2Errors.FirstNameErrors ? "border-danger" : ""}`} placeholder="First name" name='FirstName' ref={register} />
          </div>
          ...
          <div className="col-5" id="lastName" >
            ...
            <input type="text" className={`form-control outline first ${Register2Errors.LastNameErrors ? "border-danger" : ""}`} placeholder="Last name" name='LastName' ref={register} />
          </div>
