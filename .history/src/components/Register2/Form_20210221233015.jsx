...
export const Form = (props) => {
  ...
  const handleRegister2 = () => {
    if (errors.FirstName || errors.LastName || errors.Password){
      document.getElementById("CreateButton").style.disabled(this.state.isDisabled)
    }else{
    ...
    <div className="row">
      ...
      <div className="col-xl-6 col-12 col-sm-12 col-md-12" id="form2Design">
        ...
        <div className="row">
          ...
          <button id="CreateButton" type="submit" className="btn btn-white btns" onClick={handleRegister2}>
