    ...
    <div className="row">
      ...
      <div className="col-xl-6 col-12 col-sm-12 col-md-12" id="form2Design">
        ...
        <div className="row">
            ...
            <div className="check">
                <input type="checkbox" htmlFor="check" name='check' ref={register} /> Yes! Send me genuinely useful emails every
          now and then to help me get the most out of Upwork.
        </div>
            <br />
            <div className="check2">
                <input type="checkbox" htmlFor="check"  name='check' ref={register} /> Yes, I understand and agree to the
