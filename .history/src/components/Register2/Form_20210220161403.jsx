    ...
    <div className="row" id="inputbox">
      <div className="col-5" id="firstName">
        {/* <i class="fas fa-user" id="icon"></i> */}
              <input type="text" className="outline first" placeholder="First name" onChange={handleForm} name='FirstName' value={Register2Form.email}/>
      </div>
            <div className="col-2" id="emptyCol"></div>
      <div className="col-5" id="lastName">
        {/* <i class="fas fa-user" id="icon2"></i> */}
              <input type="text" className="outline first" placeholder="Last name" onChange={handleForm} name='LastName' value={Register2Form.email} />
      </div>
    </div>
    <br />
    <div className="row">
      <div className="col-12">
              <input type="password" className="outline pass" placeholder="Create a password" onChange={handleForm} name="Password" value={Register2Form.email} />
      </div>
    </div>
    <br />
    <div className="row">
