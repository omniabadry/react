  ...
  <div className="col-xl-6 col-12 col-sm-12 col-md-12" id="form2Design">
    ...
    <div className="row">
      <div className="col-12">
              <input type="password" onChange={handleForm} placeholder="Password" name="Password" className={`form-control outline pass p-2 ${Register2Errors.PasswordErrors ? "border-danger" : ""}`} value={Register2Form.Password} />
      </div>
    ...
    <br /><br />
          <a href="../2/signUp2.html"> <button id="CreateButton" type="button" className="btn btn-white btns" disabled={Register2Form.FirstNameErrors || Register2Form.LastNameErrors || Register2Form.PasswordErrors}>
