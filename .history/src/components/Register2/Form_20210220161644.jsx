    ...
    <div className="row" id="inputbox">
      ...
      <div className="col-5" id="lastName">
        {/* <i class="fas fa-user" id="icon2"></i> */}
              <input type="text" className={`form-control outline first ${Register2Errors.emailErrors ? "border-danger" : ""}`} placeholder="Last name" onChange={handleForm} name='LastName' value={Register2Form.LastName} />
      </div>
    </div>
    <br />
    <div className="row">
