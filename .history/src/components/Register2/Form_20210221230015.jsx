...
const schema = yup.object().shape({
  ...
  check: yup.boolean().oneOf([false], "You must accept the terms and conditions").required(),
    ...
    <div className="row">
      ...
      <div className="col-xl-6 col-12 col-sm-12 col-md-12" id="form2Design">
        ...
        <div className="row">
          ...
          <button id="CreateButton" type="submit" className="btn btn-white btns" disabled={errors.FirstName || errors.LastName || errors.Password} onClick={handleRegister2}>
