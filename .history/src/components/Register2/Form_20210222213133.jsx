...
const schema = yup.object().shape({
  ...
  check:yup.boolean().optional.oneOf([true]).required('Must choose at least one option.'),
        ...
        <div className="row">
          ...
          now and then to help me get the most out of Upwork.
            ...
            <div className="check2">
                <input type="checkbox" name='is_active' ref={register} 
          ...
          <button id="CreateButton" type="submit" className="btn btn-white btns" disabled=
            {errors.FirstName || errors.LastName || errors.Password || errors.check} onClick={handleRegister2}>
