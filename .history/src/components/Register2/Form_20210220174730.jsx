  ...
  <div className="col-xl-6 col-12 col-sm-12 col-md-12" id="form2Design">
    ...
    <div className="row">
      <div className="col-12">
              <input type="password" name="Password" className={`form-control outline pass ${Register2Errors.PasswordErrors ? "border-danger" : ""}`} placeholder="Create a password" onChange={handleForm}  value={Register2Form.Password} />
      </div>
            <h6>{Register2Errors.LastNameErrors}</h6>
    </div>
    <br />
