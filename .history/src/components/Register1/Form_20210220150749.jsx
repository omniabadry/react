    ...
    return (
        <div className="row">
            ...
            <div className="col-xl-8 col-12 col-sm-12 col-md-12" id="form1Design">
                ...
                <input type="email" placeholder="Work email address" id="emailField" onChange={handleRegister1} className={`form-control ${Register1Errors.emailErrors ? "border-danger" : ""}`} value={Register1Form.email} />
