    ...
    return (
        <div className="row">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="col-xl-8 col-12 col-sm-12 col-md-12" id="form1Design">
                ...
                <input type="email" placeholder="Work email address" name="email" id="emailField"  
                className={`form-control ml-5 ${errors ? "border-danger" : ""}`}
                  />
                <div className="text-danger">
                    {errors.Email && errors.Email.message}
                </div>              
                  <button id="EmailButton" type="submit" className="btn btn-white btns" >
