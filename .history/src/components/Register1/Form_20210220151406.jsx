    ...
    return (
        <div className="row">
            ...
            <div className="col-xl-8 col-12 col-sm-12 col-md-12" id="form1Design">
                ...
                <input type="email" placeholder="Work email address" id="emailField" onChange={handleForm} 
                ...
                <button id="EmailButton" type="button" className="btn btn-white btns" onClick={handleRegister1} disabled={Register1Errors.emailErrors || Register1Errors.passwordErros}>
