    ...
    return (
        <form className="modal-content p-3 my-5" style={{ borderRadius: '1rem' }}>
            ...
            <div className="modal-body">
                ...
                <input className="form-control text-left mb-2 p-4" type="text" placeholder="EX: Northwestern University" /><br />
                <label className="text-left mb-3"><b>Area of Study (Optional)</b></label>
                <input className="form-control text-left mb-2 p-4" type="text" placeholder="EX: Computer Science" /><br />
                <label className="text-left mb-3"><b>Degree (Optional)</b></label>
                <input className="form-control text-left mb-2 p-4" type="text" placeholder="EX: Bachelor's" /><br />
