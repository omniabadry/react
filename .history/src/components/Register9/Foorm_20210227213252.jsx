...
export const Foorm = () => {
    ...
    return (
        <div className="col-xl-7 col-12 col-sm-12 col-md-12" id="form9Design">
            <div>
                <p className="card crdhd"><b>{t("Education")}</b><span className="text-muted mutepara">{t("4 of 11")}</span></p>
                <div id="crd" >
                    <p className="card-title" id="crdtitle">{t("Add the schools you attended, areas of study, and degreesearned.")}</p><br />
                    <div className="row" >
                        <div className="col-12 mb-5" >
                            <button className="btn btn-outline addEdue9" onClick={openModal}>
                                <i className="fas fa-plus" />&nbsp;&nbsp;<b>{t("Add Education")}</b>
                            </button><br /><br /><br />
                            <button className="btn-link mb-2 skipBtn" type="submit" onClick={handleRegisterNext9}>{t("Skip this step")}</button>
                            <Modal isOpen={modalIsOpen} onAfterOpen={afterOpenModal} onRequestClose={closeModal}
                                contentLabel="Example Modal">
                                <div className="modal-header" >
                                    <h2 className="modal-title text-left p-0">{t("Add education")}</h2>
                                ...
                                <div className=" mt-0 pt-1">
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        <div className="col-lg-12">
                                            <div className="form-group">
                                                <div className="sn-field ">
                                                    <label className="text-left mt-3 mb-3"><b>{t("School")}</b></label>
                                                    <br />
                                                    <input className=" text-left mb-2 p-4 col-lg-12 " type="text"
                                                        style={{ borderRadius: '0.5rem' }} name="school" ref={register}
                                                        placeholder={t("Ex: Northwestern University")} /><br />
                                                </div>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="form-group">
                                                <div className="sn-field">
                                                    <label className="text-left mb-3"><b>{t("Area of Study")}</b></label>
                                                    <br />
                                                    <input className=" text-left mb-2 p-4 col-lg-12 " type="text"
                                                        style={{ borderRadius: '0.5rem' }} name="study" ref={register} 
                                                        placeholder={t("Ex: Computer Science")}/><br />
                                                </div>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="form-group">
                                                <div className="sn-field">
                                                    <label className="text-left mb-3"><b>{t("Degree")}</b></label> <br />
                                                    <input className=" text-left mb-2 p-4 col-lg-12 " type="text"
                                                        style={{ borderRadius: '0.5rem' }} name="degree" ref={register}
                                                        placeholder={t("Ex: Bachelor's")} /><br />
                                                </div>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="price-sec">
                                                ...
                                                <div className="form-group">
                                                    <label className="text-left mb-3 "><b>{t("Dates Attended")} </b></label>
                                                    <br />
                                                    <div className="row">
                                                ...
                                                {/* <div className="col-lg-12">
                                            <div className="form-group"> */}
                                                <label className="text-left mb-3"><b>{t("Description")}</b></label>
                                        ...
                                        <div className="modal-footer">
                                            <button type="button" className="btn btn-default btn-link cancelBtn" onClick={closeModal} data-dismiss="modal">{t("Cancel")}</button>
                        ...
                        <div className="card-footer bg-white crdfooter">
                            <button className="btn btn-link btn-success col-lg-5 col-sm-12 mb-3" id="nextBtn6" type="submit" onClick={handleRegisterNext9} ><b>{t("Next")}</b></button>
                            <button className="btn btn-link btn-outline col-lg-5 col-sm-12 mb-3" id="backBtn" type="submit" onClick={handleRegisterBack9}><b>{t("Back")}</b></button>
                        </div>
                    </div>
                </div>
            </div>
