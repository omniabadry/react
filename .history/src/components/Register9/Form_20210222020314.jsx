    ...
    <form className="col-xl-7 col-12 col-sm-12 col-md-12" id="form9Design">
      <div className="card-fluid">
        ...
        <div className="card-footer bg-white crdfooter">
          <button className="btn btn-link btn-success col-lg-5 col-sm-12 mb-3" id="nextBtn6" type="submit" disabled={errors.School} onClick={handleRegisterNext9}><b>Next</b></button>
