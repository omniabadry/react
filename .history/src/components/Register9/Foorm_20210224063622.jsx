                                        ...
                                        <div className="col-lg-12">
                                            <div className="form-group">
                                                <div className="sn-field ">
                                                    ...
                                                    <br />
                                                    <input className="text-left mb-2 col-lg-12" type="text" name="school" ref={register} placeholder={t("EX: Northwestern University")} />
                                                </div>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="form-group">
                                                <div className="sn-field">
                                                    ...
                                                    <input className="text-left mb-2 col-lg-12" type="text" ref={register} name="degree" placeholder={t("Ex: Bachelor's")} />
                                                </div>
