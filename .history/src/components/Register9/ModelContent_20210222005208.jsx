...
export const ModelContent = () => {
    ...
    const onSubmit = () => { }
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="modal-content p-3 my-5" style={{ borderRadius: '1rem' }}>
            ...
            <div className="modal-body">
                ...
                <input className={`form-control text-left mb-2 p-4 ${errors.LastName ? " border-danger" : ""}`} name='School' ref={register} type="text" placeholder="EX: Northwestern University" /><br />
            {/* //    className={`form-control outline first ${errors.LastName ? "border-danger" : ""}`} */}
                ...
                <input className="form-control text-left mb-2 p-4" name='Area_of_Study' ref={register} type="text" placeholder="EX: Computer Science" /><br />
                <div className="text-danger">
                    {errors.Area_of_Study && errors.Area_of_Study.message}
                </div>
                <label className="text-left mb-3"><b>Degree (Optional)</b></label>
                <input className="form-control text-left mb-2 p-4" name='Degree' ref={register} type="text" placeholder="EX: Bachelor's" /><br />
                <div className="text-danger">
                ...
                <textarea type="text" placeholder="Sescribe your studies, awards,etc" name="Description" ref={register} defaultValue={""} />
                <div className="text-danger">
            ...
            <div className="modal-footer p-4">
                ...
                <button type="submit" disabled=
                    {errors.School} className="btn btn-outline-success saveAddMore d-lg-inline d-none">Save &amp; Add
                More</button>
                <button type="submit" className="btn btn-success saveBtn" disabled=
                    {errors.School}>Save</button>
            </div>
        </form>
    )
}
