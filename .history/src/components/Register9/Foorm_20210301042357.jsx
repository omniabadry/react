      ...
      <div className="col-xl-7 col-12 col-sm-12 col-md-12" id="form9Design">
        <div>
          <p className="card crdhd">
            <b>{t("Education")}</b>
            <span className="text-muted mutepara">4 {t("of")} 11</span>
          </p>
          <div id="crd">
            <p className="card-title" id="crdtitle">
              {t(
                "Add the schools you attended, areas of study, and degreesearned."
              )}
            </p>
            <br />
            <div className="row">
                        ...
                        <div className="form-group">
                          <div className="sn-field ">
                            ...
                            <input
                              ...
                              name="school"
                              ref={register}
                              placeholder={t("Ex: Northwestern University")}
                            />
                            <br />
                          </div>
                          <ErrorMessage
