      ...
      >
        <div className="card-fluid">
          <p className="card crdhd">
            <b>{t("Phone number")}</b>
            <span className="text-muted mutepara">11 {t("of")} 11</span>
          </p>
          <form
            onSubmit={handleSubmit(onSubmit)}
            className="card-body"
            id="crd"
          >
            <h3 className="card-title mb-4" id="crdtitle">
              {t("Add your phone number.")}
            </h3>
            <div className="card-text">
              <div className="row">
                <div className="col-12">
                  <label className="text my-4">
                    <b>{t("Phone")}</b>
                  </label>
                  <br />
                  <div
                  ...
                  >
                    <button
                      id="btnGroupDrop1"
                      type="button"
                      className="btn btn-outline dropdown-toggle dropdoenPhone phoneButton"
              ...
              <p className="text mb-5">
                {t("Your phone number will")} <b>{t("not")}</b>{" "}
                {t("be shared with clients.")}
              </p>
            </div>
            <div className="card-footer bg-white crdfooter">
              <button
                ...
                id="nextBtn16"
                type="submit"
                onClick={handleRegisterNext16}
              >
                <b>{t("Preview Profile")}</b>
              </button>
              <button
                className="btn btn-link btn-outline col-lg-5 col-sm-12 mb-3"
                id="backBtn"
                type="submit"
                onClick={handleRegisterBack16}
              >
                <b>{t("Back")}</b>
              </button>
            </div>
