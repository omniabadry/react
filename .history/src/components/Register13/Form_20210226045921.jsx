  ...
  <div className="card-fluid">
    ...
    <div className="card-body" id="crd">
      ...
      <div className="card-text">
        ...
        <br />
                        <button onClick={handleRegisterNext13} type="submit"><b>Skip this step</b></button>
      </div>
    </div>
    <div className="card-footer bg-white crdfooter">
                    <button className="btn btn-link btn-success col-lg-5 col-sm-12 mb-3" id="nextBtn" type="submit" onClick={handleRegisterNext13}><b>Next</b></button>
                <button className="btn btn-link btn-outline col-lg-5 col-sm-12 mb-3" id="backBtn" type="submit" onClick={handleRegisterNext13}><b>Back</b></button>
    </div>
  </div>
</form>
