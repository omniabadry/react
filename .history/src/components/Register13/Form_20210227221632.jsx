...
export const Form = () => {
  ...
  <div className="card-fluid">
    <p className="card crdhd"><b>{t("Title &amp; Overview")}</b><span className="text-muted mutepara">8 of 11</span></p>
      ...
      <div className="card-text">
        <p className="text-left"><b>Title</b>&nbsp;&nbsp;&nbsp;
          <i className="fas fa-question-circle text-success" />
              ...
              <input className="form-control" placeholder="Example: Web, Mobile & Software Dev" id="titleInput" ref={register} name="Title" />
              <ErrorMessage errors={errors} name="Title" render={FormError} />

        <p className="text-left mt-3"><b>Professional Overview</b>&nbsp;&nbsp;&nbsp;
          <i className="fas fa-question-circle text-success" />
        </p>
        
              <textarea className="form-control" ref={register} name="Overview" placeholder="Highlight your top skills, experience, and interests. This is one of the first things clients will see on your profile." id="ProfessionalInput" defaultValue={""} />
