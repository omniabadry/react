...
export const Schema = yup.object().shape({
  salary: yup
    .string()
    .matches(phoneRegExp, "hourly rate is a required field")
    .required(),
});
export const FreelancerHourlyRateSchema = yup.object().shape({
  hourly_rate: yup.string().required("hourly rate is a required field"),
});
      ...
      >
        <div className="card-fluid">
          <p className="card crdhd">
            <b>{t("Hourly Rate")}</b>
            <span className="text-muted mutepara">7 {t("of")} 11</span>
          </p>
          <div className="card-body" id="crd">
            <p className="card-title" id="crdtitle">
              {t("Clients will see this rate on your profile and in search results once you publish your profile. You can adjust your rate every time you submit a proposal.")}
            </p>
            <br />
            <div className="card-text">
              <div className="row">
                <div className="col-xl-6 col-md-12 mb-2">
                  ...
                  <p className="text-muted">{t("Total amount the client will see")}</p>
                </div>
              ...
              <div className="row">
                <div className="col-xl-6 col-md-12 my-4">
                  ...
                  <p className="text-muted">
                    {t("The Upwork Service Fee is 20% when you begin a contract with a new client. Once you bill over $500 with your client, the fee will be 10%.")}
                  </p>
                </div>
                <div className="col-xl-6 col-md-12 my-4">
              ...
              <div className="row">
                <div className="col-xl-6 col-md-12 mb-2">
                  <p>
                    <b>{t("You'll receive")}</b>
                  </p>
                  <p className="text-muted">
                    {t("The estimated amount you'll receive after service fees")}
                  </p>
                </div>
                <div className="col-xl-6 col-md-12 mb-2 text-center">
                  <input
              ...
              <div className="row container" id="containerbg">
                ...
                >
                  ...
                  >
                    <b>{t("Upwork service fees can be as low as 5%")}</b>
                  </h4>
                  <a
                    href="#myModal"
