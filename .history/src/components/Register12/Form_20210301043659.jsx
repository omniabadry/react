...
// });
  return (
   <>
  <form className="col-xl-8 col-12 col-sm-12 col-md-12 shadow-lg" id="formDesign12">
      ...
      <div className="card-body" id="crd">
        ...
        <div className="card-text">
          ...
          <div className="row container" id="containerbg">
            <div className="col-xl-8 col-md-12 mb-2 text-center" style={{paddingTop: '1.5rem'}}>
              <h4 className="text mb-4  text-left" style={{fontSize: '1.4rem'}}><b>Upwork service fees can be as low as 5%</b></h4>
                  ...
                  <div className="modal-content p-2">
                    ...
                    <div className="modal-body">
                      <div className="embed-responsive embed-responsive-16by9">
                        <iframe id="myVideo" className="embed-responsive-item" src="images/hourly-video.mp4" allowFullScreen />
                      </div>
                    </div>
            ...
            <div className="col-xl-4 col-md-12 text-right">
              <img src="images/rate.png" alt="rate pic" className="rateImg"/>

            </div>
          </div>
          <br /><br />
          <button className="btn-link mb-2 skipBtn" type="submit"><b>Skip this step</b></button>
        </div>
      </div>
      <div className="card-footer bg-white crdfooter">
        <button className="btn btn-success col-lg-5 col-sm-12 mb-3" id="nextBtn12" ><b>Next</b></button>
        <button className="btn btn-link btn-outline col-lg-5 col-sm-12 mb-3" id="backBtn12" ><b>Back</b></button>
      </div>
    </div>
  </form>
</>
