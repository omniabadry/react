...
//   return (
//    <>
//   <form className="col-xl-7 col-12 col-sm-12 col-md-12 shadow-lg" id="formDesign12">
...
// <button className="btn btn-link btn-success col-lg-5 col-sm-12 mb-3" id="nextBtn" ><b>Next</b></button>
// <button className="btn btn-link btn-outline col-lg-5 col-sm-12 mb-3" id="backBtn" ><b>Back</b></button>
//       </div>
//     </div>
//   </form>
// </>
