  ...
  <div className="card-fluid">
    ...
    <div className="card-body" id="crd">
      ...
      <div className="card-text">
        <img src="user_icon1.png" className="uploadPic" id="output1" data-toggle="modal" data-target="#myModal" /><br />
        ...
        <button className="btn-link mb-1 skipBtn">Skip this step</button>
      </div>
      {/* Modal */}
        ...
        <div className="modal-dialog  modal-xl modalContainer">
          ...
          <div className="modal-content p-3 my-5" style={{borderRadius: '1rem'}}>
            ...
            <div className="modal-body">
              <div className="row">
                <img src="user_icon1.png" className="uploadPicIcon" id="output" />
              </div>
              <hr />
