            ...
            <form onSubmit={handleSubmit(onSubmit)} className="row ">
              ...
              {/* <div className="col-xl-4 col-l-12 col-md-12 col-sm-12 mb-4" >
                <div className="form-check crdsincrd">
                  ...
                  <label className={`form-check-label ${errors.radioGroup ? "border-danger" : ""}`} name="radioGroup" ref={register} htmlFor="flexRadio">
                    <h3>Entry Level</h3>
              ...
              {/* <div className="col-xl-4 col-l-12 col-md-12 col-sm-12 mb-4">
                <div className="form-check crdsincrd">
                  ...
                  <label className={`form-check-label ${errors.radioGroup ? "border-danger" : ""}`} name="radioGroup" ref={register} htmlFor="flexRadio2">
                    <h3>Intermediate</h3>
              ...
              {/* <div className="col-xl-4 col-l-12 col-md-12 col-sm-12 mb-4">
                <div className="form-check crdsincrd">
                  ...
                  <label className={`form-check-label ${errors.radioGroup ? "border-danger" : ""}`} name="radioGroup" ref={register} htmlFor="flexRadio3">
                    <h3>Expert</h3>
