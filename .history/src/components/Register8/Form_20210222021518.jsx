        ...
        <div className="card-body" id="crd">
          ...
          <div className="card-text">
            ...
            <div className="card-footer bg-white crdfooter">
              <a href="../8/signUp8.html"> <button className="btn btn-link btn-success col-lg-5 col-sm-12 mb-3" id="nextBtn6" href="#"><b>Next</b></button></a>
              <a href="../6/signUp6.html"> <button className="btn btn-link btn-outline col-lg-5 col-sm-12 mb-3" id="backBtn" href="#"><b>Back</b></button></a>
            </div>
          </div>
        </div>
      </div>
