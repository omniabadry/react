    ...
    >
      <div className="card-fluid">
        <p className="card crdhd">
          <b>Expertise</b>
          <span className="text-muted mutepara">2 of 11</span>
        </p>
        <div className="card-body" id="crd">
          ...
          <div className="card-text">
            <label>
              <h4>What is the main service you offer?</h4>
            </label>
            {/* <Allservices /> */}
            ...
            <label>
              <h4>What skills do you offer clients?</h4>
            </label>
            <br />
            ...
            <h4 className="inputInline my-5">Not what you're looking for? </h4>
