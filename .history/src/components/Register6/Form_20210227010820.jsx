  ...
  { value: 'Web, Mobile & Software Dev', label: 'Web, Mobile & Software Dev' }
      ...
      return (
            <form  onSubmit={handleSubmit(onSubmit)} className="col-xl-7 col-12 col-sm-12 col-md-12" id="form6Design">
              ...
              <h4 className="inputInline">Not what you're looking for? </h4><i className="fas fa-question-circle iconHelp" /><br/>

 <CustomSelect ref={register} options={options} id="inputStart" isMulti name="select3" /><br/>
