...
export const Form = () => {
  ...
  const options = [
    ...
    {value: "Web, Mobile & Software Dev", label: t("Web, Mobile & Software Dev")},
  ];
    ...
    >
      <div className="card-fluid">
        <p className="card crdhd">
          <b>{t("Expertise")}</b>
          <span className="text-muted mutepara">{t("2 of 11")}</span>
        </p>
        <div className="card-body" id="crd">
          ...
          <div className="card-text">
            ...
            <label>
              <h4>{t("What skills do you offer clients?")}</h4>
            </label>
            <br />
            ...
            <h4 className="inputInline my-5">{t("Not what you're looking for?")} </h4>
            <i className="fas fa-question-circle iconHelp" />
            <br />
