...
import { Register14 } from "./components/Register14/Register14";
import { Register15 } from "./components/Register15/Register15";
import { Register16 } from "./components/Register16/Register16";
...
function App() {
    ...
    return ( <
        ...
        /> { /* <Route path="/Register12" exact component={Register12} /> */ } <
        Route path = "/Register13"
        exact component = { Register13 }
        /> <
        Route path = "/Register14"
        exact component = { Register14 }
        /> <
        Route path = "/Register15"
        exact component = { Register15 }
        /> <
        Route path = "/Register16"
        exact component = { Register16 }
        /> <
        /Switch> <
        /Router>
